...
/****** Object:  StoredProcedure [dbo].[hpx_Synchro_FaVFaVZdroj]    Script Date: 26.06.2025 9:09:07 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[hpx_Synchro_FaVFaVZdroj]
...
-- =============================================
-- Author:		DJ
-- Description:	Spuštění synchronizace FaV > FaV - zdrojová DB
-- =============================================
...
BEGIN TRY
	...
	SET @ExecSQL = N'EXEC ' + @SQLCil + N'[dbo].[hpx_Synchro_FavFavCil]' + @CRLF +
N'	@DBZdroj' + @CRLF +
