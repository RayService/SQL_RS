...
/****** Object:  StoredProcedure [dbo].[hpx_HeliosZOOM_KontJednani_Novy]    Script Date: 26.06.2025 9:36:07 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROC [dbo].[hpx_HeliosZOOM_KontJednani_Novy] @Kategorie NVARCHAR(3),@Predmet NVARCHAR(255),@DatumJednaniOd DATETIME,@DatumJednaniDo DATETIME,@Typ NVARCHAR(3),@Stav NVARCHAR(3),@Popis NTEXT,@CisloOrg INT
AS
