...
/****** Object:  StoredProcedure [dbo].[hpx_RS_material_operations_qa_preparation]    Script Date: 26.06.2025 15:50:18 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROC [dbo].[hpx_RS_material_operations_qa_preparation]
@ID INT
AS
-- ============================================================================================
-- Author:		MŽ
-- Create date:            24.8.2021
-- Description:	Vložení 3 operací technické kontroly pro dílce typu přípravky SK=899
-- ============================================================================================
/*Nové generování operací pro protikusy. U dílců SK = 899.
...
WHERE x.rn=1;
-- vzorový dílec
DECLARE @IDHlavickaOrig INT=160186;
-- dohledání ID vzorové operace číslo 1
...
WHERE x.rn=3)
--MŽ 21.10.2024 na přání PŠ přidávám 4.operaci
