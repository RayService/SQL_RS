...
/****** Object:  StoredProcedure [dbo].[hpx_Balikobot_Validace_gls]    Script Date: 26.06.2025 14:50:10 ******/
SET ANSI_NULLS ON
GO
...
/*rpBalikobot.Export*/CREATE PROC [dbo].[hpx_Balikobot_Validace_gls]
@IdZasilky INT,
...
END
END
IF EXISTS(SELECT * FROM Tabx_BalikobotBaliky WHERE IdZasilky=@IdZasilky AND (sms_notification=1 OR phone_notification=1))
BEGIN
...
END
END
IF (SELECT service_type FROM Tabx_BalikobotZasilky WHERE ID=@IdZasilky)='2'
BEGIN
