...
/****** Object:  StoredProcedure [dbo].[hpx_Balikobot_Validace_geis]    Script Date: 26.06.2025 14:49:35 ******/
SET ANSI_NULLS ON
GO
...
/*rpBalikobot.Export*/CREATE PROC [dbo].[hpx_Balikobot_Validace_geis]
@IdZasilky INT,
...
END
END
IF (SELECT service_type FROM Tabx_BalikobotZasilky WHERE ID=@IdZasilky)='6'
BEGIN
