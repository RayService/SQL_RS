...
/****** Object:  View [dbo].[hvw_RozdilKVydeji]    Script Date: 04.07.2025 8:04:39 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[hvw_RozdilKVydeji] AS SELECT SU.ID, SU.IDStavSkladu, SU.IDVyrCis, SU.IDUmisteni, KZ.SkupZbo, KZ.RegCis, U.Kod, SU.Mnozstvi, KZID=KZ.ID, SS.IDSklad
