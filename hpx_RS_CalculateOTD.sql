...
/****** Object:  StoredProcedure [dbo].[hpx_RS_CalculateOTD]    Script Date: 26.06.2025 13:40:01 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[hpx_RS_CalculateOTD]
AS
...
DELETE FROM Tabx_RS_OTDExternalPBI
--celkové OTD
...
--uložení dat
INSERT INTO Tabx_RS_OTDExternalPBI (Week_1_all,Week_1_NOK,Month_all,Month_NOK,Month_1_all,Month_1_NOK,Quarter_all,Quarter_NOK,Quarter_1_all,Quarter_1_NOK,Year_all,Year_NOK,Year_1_all,Year_1_NOK,Type)
