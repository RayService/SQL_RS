...
/****** Object:  StoredProcedure [dbo].[hpx_Balikobot_Validace_dpd]    Script Date: 26.06.2025 14:47:43 ******/
SET ANSI_NULLS ON
GO
...
/*rpBalikobot.Export*/CREATE PROC [dbo].[hpx_Balikobot_Validace_dpd]
@IdZasilky INT,
...
END
END
IF (SELECT service_type FROM Tabx_BalikobotZasilky WHERE ID=@IdZasilky)='3'
BEGIN
