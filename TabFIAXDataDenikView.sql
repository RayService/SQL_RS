...
/****** Object:  View [dbo].[TabFIAXDataDenikView]    Script Date: 04.07.2025 10:52:53 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[TabFIAXDataDenikView]    --UPDATED 20160808 
AS 
SELECT
D.*, 
...
FROM /*SysJmenoDatabase*/.dbo.TabFIAData AS D
