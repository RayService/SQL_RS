...
/****** Object:  Table [dbo].[Tabx_RS_CNRuskeSankce3]    Script Date: 02.07.2025 9:02:23 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[Tabx_RS_CNRuskeSankce3](
 ...
 CONSTRAINT [PK__Tabx_RS_CNRuskeSankce3__ID] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
...
ALTER TABLE [dbo].[Tabx_RS_CNRuskeSankce3] ADD  CONSTRAINT [DF__Tabx_RS_CNRuskeSankce3__Archive]  DEFAULT ((0)) FOR [Archive]
GO

ALTER TABLE [dbo].[Tabx_RS_CNRuskeSankce3] ADD  CONSTRAINT [DF__Tabx_RS_CNRuskeSankce3__Autor]  DEFAULT (suser_sname()) FOR [Autor]
GO

ALTER TABLE [dbo].[Tabx_RS_CNRuskeSankce3] ADD  CONSTRAINT [DF__Tabx_RS_CNRuskeSankce3__DatPorizeni]  DEFAULT (getdate()) FOR [DatPorizeni]
GO
