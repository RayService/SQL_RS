...
/****** Object:  StoredProcedure [dbo].[hpx_RS_process_BOM__plan_bulk_generating]    Script Date: 26.06.2025 13:53:35 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROC [dbo].[hpx_RS_process_BOM__plan_bulk_generating]
@IDZmeny INT,
@ID INT
AS
-- ============================================================================================
