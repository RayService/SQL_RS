...
/****** Object:  View [dbo].[TabGprPolPlanKalendNepZdrojeView]    Script Date: 04.07.2025 11:08:28 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[TabGprPolPlanKalendNepZdrojeView] AS 
SELECT 
 IDGprNepZdroje=NZ.ID, 
 ...
 PKP.datum, PKP.MinOd, PKP.MinDo, PKP.KoefPlneni, PKP.IDSmeny, PKP.CasOd, PKP.CasDo 
   FROM TabGprNepZdroje NZ
     INNER JOIN TabPlanKalendPol PKP ON (PKP.minOd IS NOT NULL AND PKP.IDPlanKalend = NZ.IDPlanKalend) 
