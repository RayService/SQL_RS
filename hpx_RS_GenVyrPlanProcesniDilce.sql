...
/****** Object:  StoredProcedure [dbo].[hpx_RS_GenVyrPlanProcesniDilce]    Script Date: 26.06.2025 11:00:20 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[hpx_RS_GenVyrPlanProcesniDilce] @ID INT
AS
...
WHERE
(((tpl.ID = @ID/*IN (111704,111705)*/))AND(tkz.SkupZbo LIKE N'93%'))
