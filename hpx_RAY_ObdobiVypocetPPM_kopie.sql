...
/****** Object:  StoredProcedure [dbo].[hpx_RAY_ObdobiVypocetPPM_kopie]    Script Date: 26.06.2025 8:55:24 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROC [dbo].[hpx_RAY_ObdobiVypocetPPM_kopie]  @DatOd DATETIME,   @DatDo DATETIME
	,@IDOrg INT
AS
-- ==============================================================
...
SELECT CO.ID, CO.CisloOrg, COE._RAY_PuvodOrg_JOC  FROM TabCisOrg CO LEFT JOIN TabCisOrg_EXT COE ON COE.ID=CO.ID WHERE CO.JeOdberatel=1 AND CO.ID = @ID ORDER BY CO.ID ASC 
OPEN JOC1_cur
