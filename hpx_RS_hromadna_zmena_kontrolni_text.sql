...
/****** Object:  StoredProcedure [dbo].[hpx_RS_hromadna_zmena_kontrolni_text]    Script Date: 26.06.2025 12:48:12 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[hpx_RS_hromadna_zmena_kontrolni_text] @Prepsat BIT, @IDZmeny INT, @KontrolniText NVARCHAR(255), @ID INT
AS
...
BEGIN TRAN 
  IF @IDZakazModif=0 
	...
	UPDATE tpe SET tpe._EXT_RS_kontrola_operace=@KontrolniText
