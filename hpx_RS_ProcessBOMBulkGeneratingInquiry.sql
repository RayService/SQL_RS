...
/****** Object:  StoredProcedure [dbo].[hpx_RS_ProcessBOMBulkGeneratingInquiry]    Script Date: 26.06.2025 14:08:58 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[hpx_RS_ProcessBOMBulkGeneratingInquiry]
@IDZmeny INT,
@ID INT
AS
-- ============================================================================================
