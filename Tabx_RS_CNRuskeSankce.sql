...
/****** Object:  Table [dbo].[Tabx_RS_CNRuskeSankce]    Script Date: 02.07.2025 9:01:26 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[Tabx_RS_CNRuskeSankce](
 ...
 CONSTRAINT [PK__Tabx_RS_CNRuskeSankce__ID] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
...
ALTER TABLE [dbo].[Tabx_RS_CNRuskeSankce] ADD  CONSTRAINT [DF__Tabx_RS_CNRuskeSankce__Archive]  DEFAULT ((0)) FOR [Archive]
GO

ALTER TABLE [dbo].[Tabx_RS_CNRuskeSankce] ADD  CONSTRAINT [DF__Tabx_RS_CNRuskeSankce__Autor]  DEFAULT (suser_sname()) FOR [Autor]
GO

ALTER TABLE [dbo].[Tabx_RS_CNRuskeSankce] ADD  CONSTRAINT [DF__Tabx_RS_CNRuskeSankce__DatPorizeni]  DEFAULT (getdate()) FOR [DatPorizeni]
GO
