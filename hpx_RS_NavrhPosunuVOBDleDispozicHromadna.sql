...
/****** Object:  StoredProcedure [dbo].[hpx_RS_NavrhPosunuVOBDleDispozicHromadna]    Script Date: 26.06.2025 13:57:18 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[hpx_RS_NavrhPosunuVOBDleDispozicHromadna]
AS

DECLARE @IDKmen INT

DECLARE CurOznacene CURSOR FAST_FORWARD LOCAL FOR 
SELECT DISTINCT IDKmen
FROM Tabx_RS_IDKmenVOB

OPEN CurOznacene 
    FETCH NEXT FROM CurOznacene INTO @IDKmen
