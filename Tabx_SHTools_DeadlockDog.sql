...
/****** Object:  Table [dbo].[Tabx_SHTools_DeadlockDog]    Script Date: 02.07.2025 10:32:33 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[Tabx_SHTools_DeadlockDog](
 ...
 CONSTRAINT [PK__Tabx_SHTools_DeadlockDog__ID] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
...
ALTER TABLE [dbo].[Tabx_SHTools_DeadlockDog]  WITH CHECK ADD  CONSTRAINT [FK__Tabx_SHTools_DeadlockDog__IDSber] FOREIGN KEY([IDSber])
REFERENCES [dbo].[Tabx_SHTools_DeadlockDogSber] ([ID])
GO

ALTER TABLE [dbo].[Tabx_SHTools_DeadlockDog] CHECK CONSTRAINT [FK__Tabx_SHTools_DeadlockDog__IDSber]
GO
