...
/****** Object:  StoredProcedure [dbo].[hpx_RS_ProcessBOMPlanBulkGeneratingInquiry]    Script Date: 26.06.2025 14:09:40 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[hpx_RS_ProcessBOMPlanBulkGeneratingInquiry]
@IDZmeny INT,
@ID INT
AS
-- ============================================================================================
...
-- Description:	Generování podřízených procesních dílců hromadně za dílce z označených výr.plánů. Včetně výběru změny.
-- ============================================================================================
...
SELECT @IDHlavicka = (SELECT IDTabKmen FROM TabPlan WHERE ID=@ID)
...
DECLARE CurGenKVazby CURSOR LOCAL FAST_FORWARD FOR
	...
	WHERE tsze._EXT_RS_GenerovatKusovnikPopt=1;
		OPEN CurGenKVazby;
		...
		UPDATE tpkmz SET tpkmz.VychoziSklad=N'20000275900', tpkmz.RadaVyrPlanu=N'TPV',tpkmz.RadaVyrPrikazu=N'950',tpkmz.DobaMeziPrikazy=480,tpkmz.VyraditZGenerPodrizPrikazu=1
