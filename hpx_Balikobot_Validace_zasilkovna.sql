...
/****** Object:  StoredProcedure [dbo].[hpx_Balikobot_Validace_zasilkovna]    Script Date: 26.06.2025 15:03:15 ******/
SET ANSI_NULLS ON
GO
...
/*rpBalikobot.Export*/CREATE PROC [dbo].[hpx_Balikobot_Validace_zasilkovna]
@IdZasilky INT,
...
BEGIN
SET @ErrorMsgParam1='"' + dbo.hfx_Balikobot_ReturnText('B34225D8-CA9A-4CAA-B1D1-8ED6DBE5DC8E', @Language, DEFAULT, DEFAULT, DEFAULT, DEFAULT) + '"'
SET @ErrorMsg = dbo.hfx_Balikobot_ReturnText('F26E2F23-F45F-43EC-82C4-D27171D9E0F3', @Language, @ErrorMsgParam1, DEFAULT, DEFAULT, DEFAULT)
INSERT #TabExtKom(Poznamka) VALUES(@ErrorMsg)
END
