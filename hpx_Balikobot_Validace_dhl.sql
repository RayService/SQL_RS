...
/****** Object:  StoredProcedure [dbo].[hpx_Balikobot_Validace_dhl]    Script Date: 26.06.2025 14:40:24 ******/
SET ANSI_NULLS ON
GO
...
/*rpBalikobot.Export*/CREATE PROC [dbo].[hpx_Balikobot_Validace_dhl]
@IdZasilky INT,
...
END
END
IF (SELECT ISNULL(content, '') FROM Tabx_BalikobotBaliky WHERE OrderNumber=1 AND IdZasilky=@IdZasilky)=''
BEGIN
SET @ErrorMsg = dbo.hfx_Balikobot_ReturnText('E57D5A2E-5204-4292-8AC5-2F4786B10FEB', @Language, DEFAULT, DEFAULT, DEFAULT, DEFAULT)
INSERT #TabExtKom(Poznamka) VALUES(@ErrorMsg)
END
END
GO
